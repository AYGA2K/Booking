...
@section('content')
    ...
    <section class="py-5" style="background-color: blanchedalmond" >
        <div class="container px-5">
            <h1 class="fw-bolder fs-5 mb-4">Booking</h1>
                    ...
                    <div class="row gx-0">
                        <div class="col-lg-6 col-xl-5 py-lg-5">
                            <div class="p-4 p-md-5">
                                ...
                                <div class="h2 fw-bolder">Find your next stay</div>
                                <p>
                                    Search deals on hotels, homes, and much more...</p>
                               
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-7"><div class="bg-featured-blog" style="background-image: url('images/1.png')"></div></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row gx-5">
                <div class="col-lg-4 mb-5">
                    <div class="card h-100 shadow border-0">
                        <img class="card-img-top" src="{{ asset('images/2.jpg') }}"alt="..." />
                        <div class="card-body p-4">
                ...
                <div class="col-lg-4 mb-5">
                    <div class="card h-100 shadow border-0">
                        <img class="card-img-top"src="{{ asset('images/3.jpg') }}" alt="..." />
                        <div class="card-body p-4">
